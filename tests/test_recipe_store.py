...
class TestRecipeStoreBasics:
    ...
    def test_save_assigns_id_and_updated(self, recipe_store):
        """Saving a dict without id returns one with an int id and int updated."""
        recipe_input = {
            "name": "Test Recipe",
            "group": "Meads",
            "items": ["item1", "item2"],
    ...
    def test_list_newest_first(self, recipe_store):
        ...
        saved1 = recipe_store.save(recipe1)
        ...
        saved2 = recipe_store.save(recipe2)
        time.sleep(1.0)
        ...
        saved3 = recipe_store.save(recipe3)
    ...
    def test_update_in_place(self, recipe_store):
        ...
        # Update with changed name and notes
        update_dict = {
            "name": "Updated Name",
            "notes": "updated notes",
        }
    ...
    def test_safe_group_name(self, recipe_store):
        ...
        # The stored group should be sanitized
...
class TestRecipeStoreEdgeCases:
    ...
    def test_recipe_dict_preserves_all_fields(self, recipe_store):
